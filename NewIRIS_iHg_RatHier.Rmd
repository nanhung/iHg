...
```{r}
data_t_Ntp1993RatMale230_liver <- c(1428, 2868, 4308);
...
```{r}
data_t_Ntp1993RatMale230_kidney <- c(1428, 2868,	4308);
...
```{r}
data_t_Ntp1993RatMale925_liver <- c(1428, 2868,	4308);
data_c_Ntp1993RatMale925_liver <- c(0.17, 0.29,	0.41);

plot(data_t, data_c, main = "Ntp 1993, 6 month, Oral = 925, Male rat", xlab = "Time (hr)", ylab = "CL (ug/g)", xlim = c(0, 4320), ylim = c(0.01, 20), log='y')
...
```{r}
data_t_Ntp1993RatMale925_kidney <- c(1428, 2868,	4308);
data_c_Ntp1993RatMale925_kidney <- c(60.05, 64.77, 89.5);

plot(data_t, data_c, main = "Ntp 1993, 6 month, Oral = 925, Male rat", xlab = "Time (hr)", ylab = "CK (ug/g)", xlim = c(0, 4320), ylim = c(1,500), log='y')
...
```{r}
data_t_Ntp1993RatMale3695_liver <- c(1428, 2868,	4308);
data_c_Ntp1993RatMale3695_liver <- c(0.84, 1.66, 1.7);

plot(data_t, data_c, main = "Ntp 1993, 6 month, Oral = 3695, Male rat", xlab = "Time (hr)", ylab = "CL (ug/g)", xlim = c(0, 4320), ylim = c(0.1, 100), log='y')
...
```{r}
data_t_Ntp1993RatMale3695_kidney <- c(1428, 2868,	4308);
data_c_Ntp1993RatMale3695_kidney <- c(93.55, 85.97, 92.1);
sd <- c(39.5, 8.75, 4.57)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 6 month, Oral = 3695, Male rat", xlab = "Time (hr)", ylab = "CK (ug/g)", xlim = c(0, 4320), ylim = c(1, 2000), log='y')
...
```{r}
data_t_Ntp1993RatMale3695_brain <- c(1428,  4308);
data_c_Ntp1993RatMale3695_brain<- c(0.05,	 0.01);
sd <- c(0.02, 0.01)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 6 month, Oral = 3695, Male rat", xlab = "Time (hr)", ylab = "CBrn (ug/g)", xlim = c(0, 4320), ylim = c(0.001, 10), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Male14775_liver <- c(384);
data_c_Ntp1993Male14775_liver <- c(5.49);
sd <- c(1.21)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Male rat", xlab = "Time (hr)", ylab = "CL (ug/g)", xlim = c(0, 400), ylim = c(0.1, 100), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Male14775_kidney <- c(384);
data_c_Ntp1993Male14775_kidney <- c(44.9);
sd <- c(11.7)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Male rat", xlab = "Time (hr)", ylab = "CK (ug/g)", xlim = c(0, 400), ylim = c(1, 2000), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Male14775_brain <- c(384);
data_c_Ntp1993Male14775_brain <- c(0.203);
sd <- c(0.27)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Male rat", xlab = "Time (hr)", ylab = "CBrn (ug/g)", xlim = c(0, 400), ylim = c(0.001, 10), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Female14775_liver <- c(384);
data_c_Ntp1993Female14775_liver <- c(4.31);
sd <- c(1.3)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Female rat", xlab = "Time (hr)", ylab = "CL (ug/g)", xlim = c(0, 400), ylim = c(1, 20), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Female14775_kidney <- c(384);
data_c_Ntp1993Female14775_kidney <- c(42.4);
sd <- c(16.4)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Female rat", xlab = "Time (hr)", ylab = "CK (ug/g)", xlim = c(0, 400), ylim = c(1, 2000), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r}
data_t_Ntp1993Female14775_brain <- c(384);
data_c_Ntp1993Female14775_brain <- c(0.31);
sd <- c(0.15)
sd.up <- data_c + sd
sd.dn <- data_c - sd

plot(data_t, data_c, main = "Ntp 1993, 16 day, Oral = 14775, Female rat", xlab = "Time (hr)", ylab = "CBrn (ug/g)", xlim = c(0, 400), ylim = c(0.01, 10), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
lines(Ntp1993Female14780$Time, Ntp1993Female14780$CBrnU)
legend("topleft", legend = c("Data", "Model"), lty = c(NA, 1), pch = c(1, NA))
```

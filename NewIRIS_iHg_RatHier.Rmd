...
single_1[,26:34] %>% cor() %>% corrplot(method = "number")
```

# Global evaluation/ "MCMC.check.out" has "Data" and "Predicion"
# Check simulation result with the parameter from the last iteration
```{r}
chk_1 <- read.delim("outputs/iHgRat_check_3365.out")
...
pars_Study <- c("lnPLC(1.1)", "lnPKC(1.1)", "lnPBrnC(1.1)",	"lnPRestC(1.1)",	"lnKabsC(1.1)",
                "lnKunabsC(1.1)",	"lnKbileC(1.1)",	"lnKurineC(1.1)",	"lnKbrnC(1.1)", "lnPLC(1.2)",
                "lnPKC(1.2)", "lnPBrnC(1.2)",	"lnPRestC(1.2)",	"lnKabsC(1.2)",	"lnKunabsC(1.2)",
                "lnKbileC(1.2)",	"lnKurineC(1.2)",	"lnKbrnC(1.2)", "lnPLC(1.3)", "lnPKC(1.3)",
                "lnPBrnC(1.3)",	"lnPRestC(1.3)",	"lnKabsC(1.3)",	"lnKunabsC(1.3)",	"lnKbileC(1.3)",
                "lnKurineC(1.3)",	"lnKbrnC(1.3)", 
                "lnPLC(1.4)", "lnPKC(1.4)", "lnPBrnC(1.4)",	"lnPRestC(1.4)",	"lnKabsC(1.4)",
                "lnKunabsC(1.4)",	"lnKbileC(1.4)", "lnKurineC(1.4)",	"lnKbrnC(1.4)"
                )
...
```{r}
mcmc_dens_overlay(x[,,],  pars = pars_Error)
mcmc_dens_overlay(x[,,],  pars = pars_Pop)
mcmc_dens_overlay(x[,,],  pars = pars_Study)
mcmc_dens_overlay(x[,,],  pars = pars_Dist)

mcmc_trace(x[,,], pars = pars_Error)
mcmc_trace(x[,,], pars = pars_Pop)
mcmc_trace(x[,,], pars = pars_Study)
mcmc_trace(x[,,], pars = pars_Dist)
```

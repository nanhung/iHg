...
```{r}
test <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceNtp1993BW.in.R", dir = "modeling")
...
```{r}
Aaseth <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceAasethBW.in.R", dir = "modeling")
...
```{r}
NielsenD <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceNielsenBW.in.R", dir = "modeling")
...
```{r}
Dieter <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceDieterBW.in.R", dir = "modeling")
...
```{r}
Ntp1993 <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceNtp1993BW.in.R", dir = "modeling")
...
```{r}
Ntp1993wks <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceNtp1993wksBW.in.R", dir = "modeling")
...
```{r}
Wang10000 <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceWang2013BW.in.R", dir = "modeling")
...
```{r}
Havar148 <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceHultmanBW.in.R", dir = "modeling")
...
## (Sin 1990):  
```{r}
Sin6000 <- mcsim(model = "iHgMiceBW.model.R", input = "iHgMiceSin1990BW.in.R", dir = "modeling")
...
plot(data_t, data_c, main = "Yin 1990, 10 days, Oral = 6000, Female mice", xlab = "Time (hr)", ylab = "CK (ug/g)", xlim = c(0, 240), ylim = c(0.01, 500), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
plot(data_t, data_c, main = "Yin 1990, 10 days, Oral = 6000, Female mice", xlab = "Time (hr)", ylab = "CL (ug/g)", xlim = c(0, 240), ylim = c(0.1, 100), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
plot(data_t, data_c, main = "Yin 1990, 10 days, Oral = 6000, Female mice", xlab = "Time (hr)", ylab = "CBrn (ug/g)", xlim = c(0, 240), ylim = c(0.1, 100), log='y')
arrows(data_t, sd.dn, data_t, sd.up, code=3, length=0.02, angle=90)
...
```{r, eval=F}
Micejob1 <- read.delim("C:/Users/ysl02/mcsim-6.2.0/IRIS_iHg/modeling/MiceHier/iHgMice_4880.out")
Micejob2 <- read.delim("C:/Users/ysl02/mcsim-6.2.0/IRIS_iHg/modeling/MiceHier/iHgMice_3365.out")
Micejob3 <- read.delim("C:/Users/ysl02/mcsim-6.2.0/IRIS_iHg/modeling/MiceHier/iHgMice_5916.out")
Micejob4 <- read.delim("C:/Users/ysl02/mcsim-6.2.0/IRIS_iHg/modeling/MiceHier/iHgMice_6734.out")
...
```{r}
chk_1 <- read.delim("C:/Users/ysl02/mcsim-6.2.0/IRIS_iHg/modeling/MiceHier/iHgMice_check_4880.out")
tail(chk_1)
```
